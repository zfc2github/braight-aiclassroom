<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="接收邮箱" prop="accept">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:email:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="emailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="接收邮箱" align="center" prop="accept" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="接收邮箱" prop="accept">
          <el-input v-model="form.accept" placeholder="请输入接收邮箱" />
        </el-form-item>
        <el-form-item label="抄送" prop="cc">
...
<script>
import { listEmail, getEmail, delEmail, addEmail, updateEmail } from "@/api/user/email";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除右键发送记录编号为"' + ids + '"的数据项？').then(function() {
        return delEmail(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/email/export', {
        ...this.queryParams
