<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="collectionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主题或藏品的编号" align="center" prop="collectionid" />
...
<script>
import { listCollection, getCollection, delCollection, addCollection, updateCollection } from "@/api/user/collection";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户收藏信息编号为"' + collectionids + '"的数据项？').then(function() {
